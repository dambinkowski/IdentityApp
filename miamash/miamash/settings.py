"""
Django settings for miamash project.
...
SECRET_KEY = 'django-insecure-#8lx-l=0xlmx+oyhe(i37b*nqume!&l!jfxs)&r(t!ezs)(n!-'
...
ALLOWED_HOSTS = [
    'localhost',
    'dambinkowski.pythonanywhere.com',
]
...
WSGI_APPLICATION = 'miamash.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Miamash API',
    'DESCRIPTION': 'Identity management API for Miamash',
    'VERSION': '1.0.0',
